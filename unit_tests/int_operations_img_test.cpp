...
//static test_and_log_util::result_type test_parse_w_sign_typos(test_and_log_util::out_type&);
//static test_and_log_util::result_type test_parse_w_sign(test_and_log_util::out_type&);
//static void test_parse_w_sign_speed(test_and_log_util::out_type&);
//static test_and_log_util::result_type test_parse_w_exp_typos(test_and_log_util::out_type&);
//static test_and_log_util::result_type test_parse_w_exp(test_and_log_util::out_type&);
//static void test_parse_w_exp_speed(test_and_log_util::out_type&);
